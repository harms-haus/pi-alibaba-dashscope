...
interface CodingPlanModelEntry {
  id: string;
  name: string;
  reasoning: boolean;
 ...
 */
const CODING_PLAN_MODELS: CodingPlanModelEntry[] = [
  // ---- Qwen 3.6 ----
  {
    id: "qwen3.6-plus",
    name: "Qwen 3.6 Plus",
...
export default function (pi: ExtensionAPI): void {
  ...
  if (!apiKey) {
    console.warn(
      "[alibaba-cloud] DASHSCOPE_API_KEY is not set. Models will appear available but API requests will fail. Set your API key with: export DASHSCOPE_API_KEY=sk-...",
    );
  }
